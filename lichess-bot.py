...
def play_game(li, game_id, control_queue, engine_factory, user_profile, config, challenge_queue, correspondence_queue, logging_queue, logging_configurer, logging_level):
    ...
    conversation.send_reply(SendLine('player'), f'Welcome @{opponent}  to one of the best bot of lichess! Made by @Soloboy4,Type!help for commands !')
    ...
    conversation.send_reply(SendLine('player'), f'That was a great game , Hope we meet soon @{opponent} !')
